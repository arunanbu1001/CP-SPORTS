...
import { loginAuthentication } from '../form/redux/slice';
            ...
            <form className='form'>
                <div className='user-form-control'>
                    <div>
                        ...
                        <input type='email' placeholder='Email ID' id='username' onChange={(e)=>setUsermail(e.target.value)}/>
                ...
                <div className='user-form-control'>
                    <div>
                        ...
                        <input type='password' placeholder='Enter Password' id='userpass' onChange={(e)=>setPassword(e.target.value)}/>
